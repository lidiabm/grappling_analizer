...
Detecció d'accions 
- Si hi ha qualsevol indici visual d’un intent d’enderroc, intent_finalitzacio, guard_pull, reversió o escapada, registra’l encara que no sigui complet.
- Un intent és vàlid encara que no arribi a resultat, sempre que hi hagi inici clar de la mecànica.
- En cas de dubte entre “control” i “transicio”, prioritza “transicio”.
- En cas de dubte entre “scramble” i “transicio”, prioritza “scramble”.
- En cas de dubte entre “intent_enderroc” i “scramble”, prioritza “intent_enderroc” si hi ha entrada clara.
- En cas de dubte entre “intent_finalitzacio” i “control”, prioritza “intent_finalitzacio”.
- Registra accions parcials, incompletes o interrompudes.
- Està prohibit ignorar una acció només perquè no arriba a resultat.
