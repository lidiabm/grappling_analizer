...
class ScoutingPerVideoStats(BaseModel):
    ...
    atacs_iniciats: UnknownNumber
    atacs_efectius: UnknownNumber
    intents_passada_guardia: UnknownNumber
    passades_guardia_efectives: UnknownNumber
    raspades_intentades: UnknownNumber
    raspades_efectives: UnknownNumber
    submissions_intentades: UnknownNumber
    submissions_encaixades: UnknownNumber
    recuperacions_guardia: UnknownNumber
    perdues_posicio: UnknownNumber
