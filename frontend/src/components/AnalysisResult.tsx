...
//       {stats.accions_clau?.length ? (
//         <ResultBlock title="Accions clau detectades" wide>
//           <ul className="analysis-result-list analysis-result-list-compact">
//             {stats.accions_clau.map((accio: any, index: number) => (
//               <li key={index}>
//                 <strong>{accio.temps}</strong> · {accio.lluitador} ·{" "}
//                 {accio.tipus} — {accio.descripcio}
//                 {accio.confianca
//                   ? ` (${accio.confianca})`
//                   : ""}
//               </li>
...
//         <Stat
//           label="Temps dominant"
//           value={renderValue(stats.temps_dominant_total)}
//         />

//         <Stat
//           label="Temps defensiu"
//           value={renderValue(stats.temps_defensiu_total)}
//         />

//         <Stat
//           label="Temps neutral"
//           value={renderValue(stats.temps_neutral_total)}
//         />

//         <Stat
//           label="Canvis de control"
//           value={renderValue(stats.canvis_control)}
//         />

//         <Stat
//           label="Intents de finalització"
//           value={renderValue(stats.intents_finalitzacio)}
//         />

//         <Stat
//           label="Intents d’enderroc"
//           value={renderValue(stats.intents_enderroc)}
//         />

//         <Stat
//           label="Guard pulls"
//           value={renderValue(stats.guard_pulls)}
//         />

//         <Stat
//           label="Reversions"
//           value={renderValue(stats.reversions)}
//         />

//         <Stat
//           label="Escapades"
//           value={renderValue(stats.escapades)}
//         />
//       </div>
//     </section>
//   );
